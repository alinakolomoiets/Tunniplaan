...
p8=Button(text="Operatsioonisüsteemide alused", font="Calibri 26",bg="darkorchid",command=lambda:kirjeldus_aknasse("bun.png","Operatsioonisusteemide alused")).grid(row=3,column=4,columnspan=2,rowspan=2,sticky=N+S+W+E)
p10=Button(text="Kehaline kasvatus", font="Calibri 26",bg="palevioletred",command=lambda:kirjeldus_aknasse("Kehaline kasvatus")).grid(row=3,column=7,columnspan=2,rowspan=2,sticky=N+S+W+E)
p11=Button(text="Eesti keel Grupp1", font="Calibri 26",bg="mediumpurple",command=lambda:kirjeldus_aknasse("Eesti keel Grupp 1")).grid(row=3,column=9,sticky=N+S+W+E)
p12=Button(text="Eesti keel Grupp2", font="Calibri 26",bg="darkgrey",command=lambda:kirjeldus_aknasse("Eesti keel Grupp 2")).grid(row=4,column=9,sticky=N+S+W+E)
p13=Button(text="Ajalugu", font="Calibri 26",bg="khaki",command=lambda:kirjeldus_aknasse("Ajalugu, inimgeograafia")).grid(row=3,column=10,rowspan=2,sticky=N+S+W+E)
...
p18=Button(text="Kunstiained", font="Calibri 26",bg="orchid",command=lambda:kirjeldus_aknasse("Kunstiained")).grid(row=5,column=9,columnspan=2,rowspan=2,sticky=N+S+W+E)

#Neljapäev
p19=Button(text="Andmebaasisüsteemide alused", font="Calibri 26",bg="salmon",command=lambda:kirjeldus_aknasse("Andmebaasisusteemide alused")).grid(row=7,column=2,columnspan=5,rowspan=2,sticky=N+S+W+E)
p20=Button(text="Ajalugu", font="Calibri 26",bg="khaki",command=lambda:kirjeldus_aknasse("Ajalugu, inimgeograafia")).grid(row=7,column=6,rowspan=2,sticky=N+S+W+E)
p21=Button(text="Eesti keel Grupp1", font="Calibri 26",bg="mediumpurple",command=lambda:kirjeldus_aknasse("Eesti keel Grupp 1")).grid(row=7,column=7,sticky=N+S+W+E)
p22=Button(text="Eesti keel Grupp2", font="Calibri 26",bg="darkgrey",command=lambda:kirjeldus_aknasse("Eesti keel Grupp 2")).grid(row=8,column=7,sticky=N+S+W+E)

#Reede
p23=Button(text="Vene keel", font="Calibri 26",bg="greenyellow",command=lambda:kirjeldus_aknasse("Keel ja kirjandus")).grid(row=9,column=3,columnspan=2,rowspan=2,sticky=N+S+W+E)
p24=Button(text="Matemaatika", font="Calibri 26",bg="lightpink",command=lambda:kirjeldus_aknasse("Matemaatika")).grid(row=9,column=6,columnspan=2,rowspan=2,sticky=N+S+W+E)
p25=Button(text="Suhtlemine ja kliienditeenindus", font="Calibri 26",bg="mediumslateblue",command=lambda:kirjeldus_aknasse("Suhtlemine ja klienditeenindus")).grid(row=9,column=8,columnspan=2,rowspan=2,sticky=N+S+W+E)
p26=Button(text="Ajalugu", font="Calibri 26",bg="khaki",command=lambda:kirjeldus_aknasse("Ajalugu, inimgeograafia")).grid(row=9,column=10,rowspan=2,sticky=N+S+W+E)
